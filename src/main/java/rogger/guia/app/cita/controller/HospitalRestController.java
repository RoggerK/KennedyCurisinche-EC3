...
import rogger.guia.app.cita.service.HospitalService;
...
public class HospitalRestController {
	...
	public ResponseEntity<Hospital> obtenerPorId(@PathVariable("id") Integer id) {
	...
	public ResponseEntity<Void> editar(@RequestBody Hospital hospital) {
		Hospital hos = service.obtener(hospital.getIdHospital());
		if (hos != null) {
	...
	public ResponseEntity<Void> eliminar(@PathVariable Integer id) {
		Hospital usuarioCliente = service.obtener(id);
